...
class _SearchClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], SearchClientConfiguration]
):
    ...
    async def get_document(
        ...
        cls: ClsType[_models2.LookupDocument] = kwargs.pop("cls", None)
    ...
    @overload
    async def _index(
        self, batch: _models2.IndexDocumentsBatch, *, content_type: str = "application/json", **kwargs: Any
